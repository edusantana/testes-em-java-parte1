...
/**
 * Sensor que solicita ao usuário, através de um diálogo, qual o valor da
 * medição.
 * 
 * @author eduardo
 *
...
public class MapDialogoAdapter<T> implements Sensor<T> {
	...
	public Medicao<T> realizaMedicao() {
		String leitura = (String) JOptionPane.showInputDialog(null, "Selecione o valor da leitura",
				"Leitura", JOptionPane.PLAIN_MESSAGE, null, 
		...
		String confiancaSelecionada = (String) JOptionPane.showInputDialog(null,
				"Selecione o nível de confiança da leitura", "Confiança", 
				JOptionPane.PLAIN_MESSAGE, null, nivel_de_confianca, "ham");
